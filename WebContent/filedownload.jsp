                    ...
                    <th>Download</th>
            		  ...
            		  /*Class.forName("com.mysql.jdbc.Driver"); 
        	    		...
        	    		Connection con=DriverManager.getConnection(url,username,password);
            			 ...
            			 String sql = "select id,filename from fileupload where dataowner='"+uname+"'";
            			...
            			%>
			                <tr>
			                    ...
			                    <td><a href="DownloadServlet?id=<%=rs.getInt("id")%>&filename=<%=rs.getString("filename")%>">Download <img src="images/dwnicon.png"  height="20" width="20"/></a></td>
			                </tr>
			                <%}%>
            			</tbody>
        			</table>
