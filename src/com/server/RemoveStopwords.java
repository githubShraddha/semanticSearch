...
public class RemoveStopwords {
	...
	public static String[] stopWordsofwordnet = {"a", "an", "without", "see", "unless", "due", "also", "must", "might", "like", "]", "[", "}", "{", "<", ">", "?", "\"", "\\", "/", ")", "(", "will", "may", "can", "much", "every", "the", "in", "other", "this", "the", "many", "any", "an", "or", "for", "in", "an", "an ", "is", "a", "about", "above", "after", "again", "against", "all", "am", "an", "and", "any", "are", "aren’t", "as", "at", "be", "because", "been", "before", "being", "below", "between", "both", "but", "by", "can’t", "cannot", "could",
...
//	public static void main(String[] args) {
	public static ArrayList<String> remove_stopwords(String keywords) {
		
		ArrayList<String> s = RemoveStopwords.words(keywords);
//		String keywords = "The rain in spain falls mainly on the plains, except when it's not exactly working that way! And I need+some= way. How~ will \"(this)\" \"work\"?";
//		for (String word : Split.words(keywords))
//			System.out.println(s);
	...
	public static void addStopwords() {
		...
		for (int i = 0; i < stopWordsofwordnet.length; i++) {
			stopwords.add(stopWordsofwordnet[i]);
		}
